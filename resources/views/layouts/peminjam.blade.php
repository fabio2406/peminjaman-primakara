  ...
  <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          <li class="nav-item">
            <a class="nav-link text-large {{ Request::is('peminjam/dashboard') ? 'active' : '' }}"  href="{{ url('peminjam/dashboard') }}">
              <span class="icon-large" data-feather="home"></span>
              Dashboard
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-large {{ Request::is('peminjam/pinjams*') ? 'active' : '' }}" href="{{ url('peminjam/pinjams') }}">
